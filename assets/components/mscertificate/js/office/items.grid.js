msCertificate.grid.Items = function (config) {
    ...
    msCertificate.grid.Items.superclass.constructor.call(this, config);
...
Ext.extend(msCertificate.grid.Items, OfficeExt.grid.Default, {
    windows: {},
    ...
    getTopBar: function (config) {
        return [{
            text: '<i class="fa fa-plus"></i>&nbsp;' + _('mscertificate_item_create'),
