msCertificate.utils.renderBoolean = function (value) {
    return value
        ? String.format('<span class="green">{0}</span>', _('yes'))
        : String.format('<span class="red">{0}</span>', _('no'));
};

msCertificate.utils.getMenu = function (actions, grid, selected) {
    var menu = [];
...
msCertificate.utils.renderActions = function (value, props, row) {
    var res = [];
